...
export const Dialog = mvc.View.extend({
    ...
    render: function() {
        ...
        var $bg = $('<div/>').addClass('bg').data('action', 'close');
        var $fg = $('<div/>').addClass('fg');
        var $titlebar = $('<div/>').addClass('titlebar');
        var $body = $('<div/>').addClass('body');
        var $btnClose = $('<button/>').addClass('btn-close').html(this.options.closeButtonContent).data('action', 'close');
