import { V, g, util, mvc } from '@joint/core';
...
var preparePrintArea = function(paper, areaToPrintBBox, opt) {
    ...
    printPaperEl.classList.add(util.addClassNamePrefix('print-paper'));
    ...
    if (!opt.grid) {
        // Remove the grid.
        printSVGVel.findOne('.' + util.addClassNamePrefix('grid-layer')).remove();
    }
