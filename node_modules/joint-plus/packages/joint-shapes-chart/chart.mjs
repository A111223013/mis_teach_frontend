...
import { dia, g, mvc, util, V } from '@joint/core';

const $ = mvc.$;

export const Plot = dia.Element.extend({
...
export const Pie = dia.Element.extend({
...
export const PieView = dia.ElementView.extend({
    ...
    applyGradient: function(selector, attr, gradient) {
        ...
        var selectedNodes = util.isString(selector) ? this.findNodes(selector) : $(selector).toArray();
    ...
    onClickSlice: function(event) {
        ...
        var elSlice = V(event.target.closest('.slice.outer'));
    ...
    onEventLegendItem: function(event) {
        ...
        var elLegendItem = V(event.target.closest('.legend-slice'));
...
// Matrix diagram.
export const Matrix = dia.Element.extend({
