...
export const SelectBox = mvc.View.extend({
    ...
    renderSelection: function(option) {
        ...
        if (!this.$selection) {
            this.$selection = $('<div/>').addClass('select-box-selection');
        ...
        if (option) {
            ...
            var $placeholder = $('<div/>').addClass('select-box-placeholder').html(this.options.placeholder);
    ...
    */
    ...
    OptionsView: mvc.View.extend({
        ...
        renderOptionContent: function(option) {
            ...
            var $option = $('<div/>').addClass('select-box-option-content').html(option.content);
