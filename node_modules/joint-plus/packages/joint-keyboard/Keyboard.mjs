...
util.assign(Keyboard.prototype, mvc.Events);
...
Keyboard.prototype.on = function(evt, callback, context) {
    ...
    mvc.Events.on.call(this, this.normalizeEvent(evt), callback, context);
    return this;
};
...
Keyboard.prototype.off = function(evt, callback, context) {
    ...
    mvc.Events.off.call(this, remove, callback, context);
    return this;
};
...
Keyboard.prototype.handleKey = function(evt) {
    ...
    mvc.Events.trigger.call(this, this.hash(ev), evt);
    ...
    if (this.isKeyPrintable(evt)) {
        mvc.Events.trigger.call(this, `${evt.type}:printable`, evt);
    }
};
