...
import { util, mvc, g, V } from '@joint/core';
...
export const ContextToolbar = mvc.View.extend({
    ...
    renderContent: function() {
        ...
        if (this.options.tools) {
            ...
            util.toArray(this.options.tools).forEach(function(tool) {
                ...
                var $html;
                if (tool.icon) {
                    $html = $('<img/>').prop('src', tool.icon);
                } else {
                    $html = tool.content;
                }

                var $tool = $('<button/>').addClass('tool').html($html).data('action', tool.action);
    ...
    getRoot: function() {
        ...
        return $(this.options.root || document.documentElement)[0];
    },
