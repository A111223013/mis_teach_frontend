...
import { mvc, util, V } from '@joint/core';
import {
...
export const TextEditor = mvc.View.extend({
    ...
    render: function(root) {
        ...
        this.$caret = $('<div>').addClass('caret');

        // The container for selection boxes.
        this.$selection = $('<div>');
        // One selection box covering one character.
        this.$selectionBox = $('<div>').addClass('char-selection-box');
        this.$el.append(this.$caret, this.$selection);

        this.$textareaContainer = $('<div>').addClass('textarea-container');

        this.$textarea = $('<textarea>').attr(this.options.textareaAttributes);
