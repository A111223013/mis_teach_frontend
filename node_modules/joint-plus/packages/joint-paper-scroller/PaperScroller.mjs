...
import { V, g, util, dia, mvc, env } from '@joint/core';
...
export const PaperScroller = mvc.View.extend({
    ...
    init: function() {
        ...
        const { paper, autoResizePaper, scrollWhileDragging, cursor, inertia, baseWidth, baseHeight } = options;
    ...
    zoomToRect: function(rect, opt = {}) {
        ...
        if (!opt.fittingBBox) {
            ...
            opt.fittingBBox = util.assign({}, new g.Point(paperOrigin), {
